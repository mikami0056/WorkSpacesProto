 ...
 * @author gest
 */
public class DeleteMyData extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/deletemydata.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteMyData.class.getName()).log(Level.SEVERE, null, ex);
