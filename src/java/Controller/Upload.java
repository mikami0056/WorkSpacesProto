...
public class Upload extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(view == null || !view.equals("uploadpicture")){
            ...
            UploadLogic.getInstance().uploadPicture(request, loginAccount, contextPath);
            //destination = "/WEB-INF/jsp/uploadpicturescomplete.jsp";
            destination = "MyPage";
            request.setAttribute("flag", "uploadComplete");
            
        } else {
            
            destination = "/WEB-INF/jsp/uploadpicture.jsp";
