<%-- 
    ...
    Created on : 2016/06/11, 17:54:54
    Author     : gest
--%>
...
<html>
    <head>
        ...
        <script src="/commom/JavaScript/uploadpicture.js"></script>
        ...
        <link rel="stylesheet" href="common/css/uploadpicture.css">
    </head>
    <body>
        <div id="page">
        <header id="pageHead">
        ...
        <form action="/WorkSpaces/Upload" enctype="multipart/form-data" method="POST">
